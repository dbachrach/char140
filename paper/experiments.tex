...
by Apple. %how to cite? http://www.opensource.apple.com/source/CommonCrypto/
...
\end{center}
\end{figure}
\hlfixme{fig:collider-times: The suffix length on the x-axis should be 3, 4, 5, right?}
