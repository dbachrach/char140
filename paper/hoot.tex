...
\subsection{Alternate Backends}
	...
	-- These message are short enough that they can be stored anywhere. Centralized system (Twitter, Buzz), anything that's publicly searchable (distributed or central)
