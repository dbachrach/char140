...
to address increases in computing power in Section~\ref{discuss}.
...
attacks in Section~\ref{discuss}.
...
\item[Sender anonymity or deniability] Along those lines, we can only
  ...
  used for microblogging, like BirdFeeder~\cite{sandler08}, the system
  might be extended to have anonymous posting features.)
