...
Replay attacks can be defeated by treating the session keys $\left(k_{\mathrm{enc}}, k_{\mathrm{mac}}\right)$ as nonces. It's highly unlikely that two different messages will share the same session keys.
